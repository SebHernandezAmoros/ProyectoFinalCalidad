...
namespace Transmi.Test.Controller
{
...
//--------------------------------------------------------------------------------------------------
        ...
        {
            var view = trackingController.SearchTracking(1);
        ...
        {
            var result = trackingController.CreatePackage(new Paquete { PaqueteId = 1, Contenido = "Sillas", CiudadMeta = "Cajamarca",
                CiudadOrigen = "Lima", Pagado = true, Peso = 80, PrecioEnvio = 45, DimensionX = 120, DimensionY = 80, DimensionZ = 45
            });
